### makefile automatically created by makenek 06/14/2021 10:10:13 ###
BINNAME=nek5000
LIBNAME=libnek5000.a
CASENAME:=mvtube
CASEDIR:=/home/david/projects/Nek_me/mvtube
S=/home/david/Nek5000/core
SCMT=/home/david/Nek5000/core/cmt
OPT_INCDIR=./
OBJDIR=obj

FC=mpif90
CC=mpicc
FFLAGS+=-cpp -fdefault-real-8 -fdefault-double-8 -std=legacy -fopenmp -march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/david/miniconda3/envs/moose/include
CFLAGS+=-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/david/miniconda3/envs/moose/include
LDFLAGS+=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/david/miniconda3/envs/moose/lib -Wl,-rpath-link,/home/david/miniconda3/envs/moose/lib -L/home/david/miniconda3/envs/moose/lib -Wl,--allow-multiple-definition

PPPO=
PPS= MPI UNDERSCORE GLOBAL_LONG_LONG TIMER

USR=
USR_LFLAGS= -L/home/david/Nek5000/3rd_party/blasLapack -lblasLapack -L/home/david/Nek5000/3rd_party/gslib/lib -lgs
...
VISIT_LFLAGS=
HYPRE_IFLAGS=
GSLIB_IFLAGS:= -I/home/david/Nek5000/3rd_party/gslib/include
PARRSB_IFLAGS=
